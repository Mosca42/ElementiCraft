...
public class EntityElementsOrbWind extends Entity {
	/**
	...
	public EntityElementsOrbWind(World worldIn, double x, double y, double z, int expValue) {
		super(worldIn);
	...
	public EntityElementsOrbWind(World worldIn) {
		super(worldIn);
	...
	public void onCollideWithPlayer(EntityPlayer entityIn) {
		if (!this.worldObj.isRemote) {
			entityIn.getCapability(Elementicraft.ELEMENT_CAP, null).addWindElement(1);
