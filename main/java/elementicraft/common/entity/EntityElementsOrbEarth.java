...
public class EntityElementsOrbEarth extends Entity {
	/**
	...
	public EntityElementsOrbEarth(World worldIn, double x, double y, double z, int expValue) {
		super(worldIn);
	...
	public EntityElementsOrbEarth(World worldIn) {
		super(worldIn);
	...
	public void onCollideWithPlayer(EntityPlayer entityIn) {
		if (!this.worldObj.isRemote) {
			entityIn.getCapability(Elementicraft.ELEMENT_CAP, null).addEarthElement(1);
			entityIn.getCapability(Elementicraft.ELEMENT_CAP, null).sync();
		}		
		this.setDead();
	}
