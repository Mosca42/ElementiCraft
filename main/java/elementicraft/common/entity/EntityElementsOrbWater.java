...
public class EntityElementsOrbWater extends Entity {
	/**
	...
	public EntityElementsOrbWater(World worldIn, double x, double y, double z, int expValue) {
		super(worldIn);
	...
	public EntityElementsOrbWater(World worldIn) {
		super(worldIn);
	...
	public void onCollideWithPlayer(EntityPlayer entityIn) {
		if (!this.worldObj.isRemote) {
			entityIn.getCapability(Elementicraft.ELEMENT_CAP, null).addWaterElement(1);
