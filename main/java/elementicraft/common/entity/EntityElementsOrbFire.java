...
public class EntityElementsOrbFire extends Entity {
	/**
	...
	public EntityElementsOrbFire(World worldIn, double x, double y, double z, int expValue) {
		super(worldIn);
	...
	public EntityElementsOrbFire(World worldIn) {
		super(worldIn);
	...
	public void onCollideWithPlayer(EntityPlayer entityIn) {
		if (!this.worldObj.isRemote) {
			entityIn.getCapability(Elementicraft.ELEMENT_CAP, null).addFireElement(1);
