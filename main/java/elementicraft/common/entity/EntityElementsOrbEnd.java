...
public class EntityElementsOrbEnd extends Entity {
	/**
	...
	public EntityElementsOrbEnd(World worldIn, double x, double y, double z, int expValue) {
		super(worldIn);
	...
	public EntityElementsOrbEnd(World worldIn) {
		super(worldIn);
	...
	public void onCollideWithPlayer(EntityPlayer entityIn) {
		if (!this.worldObj.isRemote) {
			entityIn.getCapability(Elementicraft.ELEMENT_CAP, null).addEndElement(1);
