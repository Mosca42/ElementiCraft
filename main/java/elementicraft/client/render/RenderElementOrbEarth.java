package elementicraft.client.render;
...
public class RenderElementOrbEarth extends Render<EntityElementsOrbEarth>
{
    private static final ResourceLocation EXPERIENCE_ORB_TEXTURES = new ResourceLocation("textures/entity/experience_orb.png");

    public RenderElementOrbEarth(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityElementsOrbEarth entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        if (!this.renderOutlines)
        {
            ...
            GlStateManager.color(50.0F, 1.0F, 1.0F, 1.0F);
            float f8 = 255.0F;
            ...
            vertexbuffer.pos(-0.5D, 0.75D, 0.0D).tex((double)f, (double)f2).color(74, 55, 40, 255).normal(0.0F, 1.0F, 0.0F).endVertex();
     ...
     */
    protected ResourceLocation getEntityTexture(EntityElementsOrbEarth entity)
    {
