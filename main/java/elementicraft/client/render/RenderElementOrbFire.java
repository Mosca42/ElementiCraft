...
public class RenderElementOrbFire extends Render<EntityElementsOrbFire>
{
    private static final ResourceLocation EXPERIENCE_ORB_TEXTURES = new ResourceLocation("textures/entity/experience_orb.png");

    public RenderElementOrbFire(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityElementsOrbFire entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        if (!this.renderOutlines)
        {
            ...
            vertexbuffer.pos(-0.5D, 0.75D, 0.0D).tex((double)f, (double)f2).color(100, 0, 0, 255).normal(0.0F, 1.0F, 0.0F).endVertex();
     ...
     */
    protected ResourceLocation getEntityTexture(EntityElementsOrbFire entity)
    {
